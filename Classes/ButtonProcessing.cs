...
namespace Telegram_Bot_Project.Classes
{
    public class ButtonProcessing
    {
        ...
        private async void ProcessTransaction(ITelegramBotClient botClient, CallbackQuery callbackQuery, CancellationToken cancellationToken, DatabaseContext db, UserDb chat, Categories1 categories1, Categories2 categories2, string data)
        {
        ...
        private async Task ProcessSuccessfulTransaction(ITelegramBotClient botClient, CallbackQuery callbackQuery, CancellationToken cancellationToken, DatabaseContext db, UserDb chat, Categories1 categories1, Categories2 categories2, string data)
        {
